...
import com.handsomexi.homework.activity.DayDayActivity;
import com.handsomexi.homework.activity.MainActivity;
...
public class a1Fragment extends Fragment {
    ...
    void OnClick(View view){
        switch (view.getId()){
            case R.id.a1_img1:{
                ...
                if (homeWorkBeanList.isEmpty()){
                    ToastUtils.showShort("当前没有数据，请拍照");
                } else {
                    Intent intent = new Intent(getActivity(),DayDayActivity.class);
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("a1Fragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("a1Fragment");
    }
