...
public class HandpickAdapter extends SimpleAdapter<HomeWorkBean>{
    ...
    public HandpickAdapter(Context context, List<HomeWorkBean> contentList){
        super(context, R.layout.item_handpick,contentList);
    }
    ...
    protected void convert(BaseViewHolder viewHoder, HomeWorkBean item) {
        ...
        viewHoder.getTextView(R.id.hand_grade).setText("年级：" + item.getSchoolYear());
        viewHoder.getTextView(R.id.hand_subject).setText("科目：" + item.getSubject());
