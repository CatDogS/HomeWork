...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void iniBean() {
        ...
        mHomeWorkBean[0] = new HomeWorkBean("a1","语文","小学二年级","上学期",3,0,new Date().getTime(),currentMonth,"语文");
        mHomeWorkBean[1] = new HomeWorkBean("a2","数学","初中三年级","下学期",2,0,new Date().getTime(),currentMonth,"数学");
        mHomeWorkBean[2] = new HomeWorkBean("a3","物理","初中二年级","下学期",1,0,new Date().getTime(),currentMonth,"物理");
        mHomeWorkBean[3] = new HomeWorkBean("a4","生物","小学五年级","上学期",4,0,new Date().getTime(),currentMonth,"生物");
        mHomeWorkBean[4] = new HomeWorkBean("a5","英语","小学六年级","下学期",5,0,new Date().getTime(),currentMonth,"英语");
        mHomeWorkBean[5] = new HomeWorkBean("a6","化学","初中一年级","上学期",2,0,new Date().getTime(),currentMonth,"化学");
        mHomeWorkBean[6] = new HomeWorkBean("a7","语文","小学一年级","下学期",1,0,new Date().getTime(),currentMonth,"语文");
        mHomeWorkBean[7] = new HomeWorkBean("a8","语文","高中二年级","上学期",2,0,new Date().getTime(),currentMonth,"语文");
        mHomeWorkBean[8] = new HomeWorkBean("a9","数学","高中三年级","下学期",3,0,new Date().getTime(),currentMonth,"数学");
        mHomeWorkBean[9] = new HomeWorkBean("a10","英语","初中三年级","上学期",3,0,new Date().getTime(),currentMonth,"英语");
